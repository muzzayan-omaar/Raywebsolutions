          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <button
                  onClick={() => setStep(2)}
                  className="bg-primary hover:bg-sky-500 transition text-white font-semibold py-2 px-6 rounded-lg shadow-lg"
                >
                  Continue
                </button>
              </motion.div>
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="mt-6 flex justify-between">
                  ...
                  <button
                    onClick={handleNext}
                    className="px-5 py-2 rounded bg-primary hover:bg-sky-500 text-white font-semibold shadow"
                  >
                    Next
                  </button>
                </div>
            ...
            {step === 3 && (
              ...
              >
                ...
                <p className="text-sm text-gray-300 mb-4">
                  We will now redirect you to a secure payment gateway to make a small deposit to confirm the start of development.
                </p>
                ...
                <div className="mt-6 flex justify-between">
                  ...
                  <button
                    onClick={() => {
                      // Replace with your Stripe redirect here
                      window.location.href = "/payment";
                    }}
                    className="px-5 py-2 rounded bg-green-500 hover:bg-green-600 text-white font-semibold shadow"
                  >
                    Proceed to Payment
                  </button>
                </div>
